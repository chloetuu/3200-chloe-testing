-- SQL Schema and Data generated automatically
...
('andres57', 'mendezrussell', '2020-07-22'),
('jenniferchambers', 'boydjudy', '2024-10-30'),
('robert44', 'xwilliams', '2024-04-06'),
('ucook', 'dpage', '2022-05-16'),
('allenluke', 'saramccarthy', '2023-09-24'),
('williamholt', 'dunnapril', '2022-10-11'),
('saramccarthy', 'walkerwendy', '2021-07-08'),
('marksanchez', 'xwilliams', '2025-03-22'),
('allenluke', 'bbaker', '2024-09-22'),
('christopherthomas', 'pmorgan', '2023-01-07'),
('mendezrussell', 'stevenstewart', '2022-07-13'),
('antonio70', 'marksanchez', '2024-10-06'),
('mjohnson', 'erinharris', '2020-05-15'),
('stewartgabriel', 'johnny76', '2022-04-15'),
('andres57', 'patrick93', '2022-03-06'),
('ucook', 'mjohnson', '2020-06-05'),
('ycook', 'sotomeghan', '2024-05-15'),
('erinharris', 'heathershannon', '2020-10-15'),
('saramccarthy', 'sotomeghan', '2024-08-12'),
('stevenstewart', 'johnny76', '2025-02-28'),
('allenluke', 'walkerwendy', '2021-06-03'),
('glasspatrick', 'antonio70', '2024-05-09'),
('mmitchell', 'andres57', '2022-12-30'),
('mjohnson', 'bbaker', '2020-05-01'),
('dpage', 'stevenstewart', '2022-03-24'),
('bbaker', 'hallbrandi', '2025-03-13'),
('christopherthomas', 'glasspatrick', '2025-03-30'),
('smiller', 'andres57', '2024-08-23'),
('saramccarthy', 'antonio70', '2023-02-17'),
('allenluke', 'stewartgabriel', '2023-01-02'),
('stevenstewart', 'allenluke', '2021-09-27'),
('jenniferchambers', 'glasspatrick', '2021-05-09'),
('boydjudy', 'bbaker', '2021-10-01'),
('walkerwendy', 'johnny76', '2022-09-10'),
('sotomeghan', 'williamholt', '2020-01-27'),
('stewartgabriel', 'boydjudy', '2021-11-09'),
('boydjudy', 'hallbrandi', '2021-06-21'),
('patrick93', 'xwilliams', '2021-06-08'),
('pmorgan', 'marksanchez', '2022-02-25'),
('walkerwendy', 'sotomeghan', '2020-03-27'),
('hallbrandi', 'antonio70', '2020-01-22'),
('stewartgabriel', 'xwilliams', '2020-11-08'),
('ucook', 'hallbrandi', '2023-02-18'),
('curtiscollier', 'antonio70', '2021-10-13'),
('stewartgabriel', 'williamholt', '2024-02-15'),
('stevenstewart', 'williamholt', '2024-08-25'),
('dpage', 'ycook', '2020-06-10'),
('andres57', 'curtiscollier', '2022-08-10'),
('stevenstewart', 'mendezrussell', '2021-08-02'),
('bbaker', 'mmitchell', '2022-03-28'),
('ucook', 'antonio70', '2025-02-02'),
('hallbrandi', 'glasspatrick', '2021-02-04'),
('walkerwendy', 'smiller', '2020-08-02'),
('glasspatrick', 'jenniferchambers', '2023-06-22'),
('andres57', 'mjohnson', '2020-04-04'),
('glasspatrick', 'saramccarthy', '2020-07-13'),
('williamholt', 'stevenstewart', '2024-11-07'),
('smiller', 'marksanchez', '2023-10-01'),
('boydjudy', 'saramccarthy', '2023-11-18'),
('stewartgabriel', 'stevenstewart', '2024-12-13'),
('saramccarthy', 'patrick93', '2022-10-07'),
('robert44', 'marksanchez', '2020-01-20'),
('pmorgan', 'williamholt', '2020-02-05'),
('patrick93', 'christopherthomas', '2024-11-18'),
('stevenstewart', 'mjohnson', '2021-01-27'),
('pmorgan', 'hallbrandi', '2021-04-15'),
('marksanchez', 'bbaker', '2022-08-15'),
('jenniferchambers', 'patrick93', '2020-06-04'),
('curtiscollier', 'xwilliams', '2020-08-08'),
('stevenstewart', 'ucook', '2020-06-07'),
('mjohnson', 'stevenstewart', '2022-06-18'),
('walkerwendy', 'saramccarthy', '2022-03-22'),
('xwilliams', 'hallbrandi', '2022-03-06'),
('ycook', 'smiller', '2022-08-02'),
('mjohnson', 'pmorgan', '2023-12-24'),
('stewartgabriel', 'allenluke', '2020-03-07'),
('smiller', 'mjohnson', '2023-05-11'),
('robert44', 'mmitchell', '2024-05-10'),
('dpage', 'mendezrussell', '2020-10-28'),
('hallbrandi', 'xallen', '2021-12-02'),
('christopherthomas', 'robert44', '2022-10-07'),
('marksanchez', 'sotomeghan', '2022-07-24'),
('patrick93', 'mcarrillo', '2025-04-01'),
('robert44', 'hallbrandi', '2020-10-28'),
('williamholt', 'johnny76', '2023-11-30'),
('christopherthomas', 'erinharris', '2021-08-16'),
('mcarrillo', 'ucook', '2023-11-10'),
('heathershannon', 'mcarrillo', '2024-09-07'),
('johnny76', 'bbaker', '2023-09-08'),
('mcarrillo', 'glasspatrick', '2020-03-30'),
('dpage', 'boydjudy', '2020-04-26'),
('stevenstewart', 'mmitchell', '2023-07-06'),
('dunnapril', 'dpage', '2024-04-22'),
('jenniferchambers', 'andres57', '2022-06-07'),
('dunnapril', 'ycook', '2023-11-20'),
('mjohnson', 'hallbrandi', '2021-07-16'),
('heathershannon', 'ycook', '2020-03-23'),
('allenluke', 'xallen', '2023-03-28'),
('antonio70', 'johnny76', '2022-07-13'),
('mendezrussell', 'xallen', '2021-07-31'),
('mmitchell', 'curtiscollier', '2024-12-28'),
('mjohnson', 'marksanchez', '2024-05-12'),
('mmitchell', 'smiller', '2021-11-29'),
('xwilliams', 'marksanchez', '2021-10-15'),
('mendezrussell', 'saramccarthy', '2024-05-21'),
('boydjudy', 'tyler63', '2020-09-19'),
('heathershannon', 'robert44', '2023-09-14'),
('smiller', 'williamholt', '2020-05-30'),
('glasspatrick', 'tyler63', '2024-01-11'),
('allenluke', 'mendezrussell', '2022-07-22'),
('curtiscollier', 'mmitchell', '2021-08-21'),
('pmorgan', 'heathershannon', '2020-02-11'),
('stevenstewart', 'christopherthomas', '2024-08-11'),
('mmitchell', 'walkerwendy', '2025-02-05'),
('christopherthomas', 'dpage', '2020-06-19');
...
('andres57', 'Michael', 'Christensen', 'Iowa', 'Low', 66, TRUE, 'Hand remember represent.
Camera generation door total company.'),
('stevenstewart', 'James', 'Ali', 'New York', 'High', 59, TRUE, 'Prevent stage all happy.'),
('mcarrillo', 'Brian', 'Davenport', 'Kansas', 'Medium', 41, FALSE, 'Season woman decide say teach. Well poor so politics kid how. Small ago rather stuff measure.'),
('marksanchez', 'Ryan', 'Sullivan', 'Delaware', 'Low', 59, TRUE, 'Image than ahead eye require energy.'),
('robert44', 'Diane', 'Leonard', 'Alaska', 'Low', 40, TRUE, 'Probably happy contain need. Because wonder social best technology away.'),
('walkerwendy', 'James', 'Johnson', 'West Virginia', 'High', 57, FALSE, 'Manage down phone measure building treat. Remain look south improve buy.'),
('tyler63', 'Kevin', 'Blanchard', 'Hawaii', 'Medium', 21, FALSE, 'Experience last should and speak manage be concern. Scientist of notice good world color include.'),
('antonio70', 'Keith', 'Carter', 'Florida', 'Low', 57, TRUE, 'Positive sound eat own. Will now nice home finally draw.'),
('glasspatrick', 'Fernando', 'Boyd', 'Arizona', 'Medium', 63, TRUE, 'Ago action measure right chance ability.'),
('stewartgabriel', 'Brandon', 'Guerra', 'Colorado', 'High', 61, FALSE, 'Campaign other pressure main skill. Group various girl knowledge who spend establish push.'),
('johnny76', 'Jacqueline', 'Summers', 'Kansas', 'High', 65, FALSE, 'Catch adult current lot strategy. Keep board challenge feel.'),
('ycook', 'Larry', 'Hernandez', 'Rhode Island', 'Low', 52, FALSE, 'Present arrive simple former enjoy argue. Morning word administration prove I.'),
('christopherthomas', 'Thomas', 'Fleming', 'Nebraska', 'Medium', 65, FALSE, 'Threat down turn cup large before notice.'),
('sotomeghan', 'Maria', 'Cherry', 'Florida', 'Medium', 46, TRUE, 'Side leave green buy. Concern street system company. Three dark speak time really box foot.'),
('heathershannon', 'David', 'Barry', 'Mississippi', 'Low', 59, TRUE, 'Exactly participant what together human all any. West maintain star husband already.'),
('jenniferchambers', 'William', 'Dudley', 'Louisiana', 'Low', 55, TRUE, 'Tax process type successful attack identify.'),
('williamholt', 'Charles', 'Lee', 'Florida', 'Low', 63, TRUE, 'Firm when especially kind stage century. Outside reach strong him American.'),
('dunnapril', 'Louis', 'Bell', 'Nevada', 'High', 31, TRUE, 'Wide discuss drug stop force outside role.'),
('mmitchell', 'Michelle', 'Jackson', 'Oklahoma', 'High', 61, FALSE, 'Black hear though.
Painting hotel skin plant score shoulder but allow. Answer himself career.'),
('curtiscollier', 'Erik', 'Bell', 'West Virginia', 'Medium', 56, FALSE, 'Laugh despite child. Simply magazine song drop throughout.'),
('patrick93', 'Todd', 'Francis', 'North Dakota', 'Low', 51, FALSE, 'Goal east car statement. Daughter discover life million reflect claim past media.'),
('xwilliams', 'John', 'Johnson', 'Kentucky', 'Low', 41, TRUE, 'Risk easy himself social hot production make bad.'),
('xallen', 'Michael', 'Day', 'Kentucky', 'Low', 30, TRUE, 'Change health pick century. Picture man two step. End wife hotel already new chair.'),
('saramccarthy', 'Rachel', 'Frye', 'Indiana', 'Low', 54, TRUE, 'Occur property can great direction which plant class. At receive while other election chance.'),
('pmorgan', 'Sarah', 'Cook', 'Colorado', 'Medium', 18, FALSE, 'Bag amount yourself success ask. Alone meeting rate opportunity environment sort.'),
('ucook', 'Elizabeth', 'Bennett', 'Rhode Island', 'Medium', 45, TRUE, 'Apply both performance second summer risk imagine.'),
('mjohnson', 'Priscilla', 'Castillo', 'Missouri', 'Medium', 69, FALSE, 'Who nice partner PM politics much. Among law when hotel leader. Ball state statement about.'),
('mendezrussell', 'Curtis', 'Ray', 'Connecticut', 'Medium', 20, FALSE, 'Technology yeah international bit car career. Economy turn air performance church six.'),
('hallbrandi', 'Melissa', 'Mcclure', 'North Carolina', 'Medium', 56, TRUE, 'Forward star bill into debate. Return within baby scene course.'),
('smiller', 'Joshua', 'Alexander', 'Georgia', 'Low', 51, TRUE, 'Church challenge want technology. Song partner inside reflect. Instead through generation point.'),
('dpage', 'Brandon', 'Mclaughlin', 'Georgia', 'High', 41, TRUE, 'House government institution so.'),
('boydjudy', 'Jennifer', 'Vincent', 'Alaska', 'High', 65, FALSE, 'Record decade trip none collection say. Small time rate building. Student manage boy.'),
('erinharris', 'Andrea', 'Harris', 'Nebraska', 'Low', 24, TRUE, 'Total cause magazine rock close audience. Give around carry huge. Special break much today single.'),
('bbaker', 'Andrew', 'Snyder', 'Mississippi', 'Low', 41, FALSE, 'According eye pick town. Laugh party performance knowledge.'),
('allenluke', 'Heather', 'Cox', 'Wisconsin', 'High', 24, TRUE, 'Reduce baby able notice on state. Never picture physical white who.');
